...
const Result = () => {
  ...
  return (
    <View className="flex-1 bg-gray-100">
      {/* Header */}
      <View className="flex-row items-center px-4 pt-14 pb-4 bg-white shadow-sm">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Diagnosis Card */}
        <View className="bg-white mx-4 mt-4 p-5 rounded-2xl shadow">
        ...
        {/* Recommended Actions */}
        <View className="bg-white mx-4 mt-4 mb-10 p-5 rounded-2xl shadow">
          <Text className="text-lg font-semibold text-gray-900 mb-4">
            Recommended Actions
          </Text>
